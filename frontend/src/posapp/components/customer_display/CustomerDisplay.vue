...
// Only events that grant transient activation. pointerdown/touchstart do not
// for touch input, so a tap on a touch display would re-arm forever.
...
const syncSubscription = () => {
	...
	// Listener is attached, so the POS window can now send enter_fullscreen.
	transport.publishControl("display_ready");
};
