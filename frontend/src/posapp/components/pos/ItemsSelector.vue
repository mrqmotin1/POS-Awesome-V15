	...
	methods: {
		...
		getItemsHeaders() {
			const items_headers = [
				...
				{ title: __("Category"), key: "item_group", width: "80px", align: "start" },
				{ title: __("MRP"), key: "rate", width: "80px", align: "start" },
				{ title: __("Stock"), key: "actual_qty", width: "80px", align: "start" },
				{ title: __("Generic"), key: "custom_generic_name", width: "80px", align: "start" },
				{ title: __("Vendor"), key: "brand", width: "80px", align: "start" },
