...
<template>
    <div>
        ...
        <v-row align="center" no-gutters class="mb-1">
            ...
            <v-col> </v-col>
            <v-col md="3" cols="12">
                <v-btn block color="warning" theme="dark" @click="$emit('search', internalPosProfileSearch)">{{
                    __("Search")
                }}</v-btn>
            </v-col>
            <v-col md="3" cols="12">
...
const emit = defineEmits(['update:posProfileSearch', 'update:currencyFilter', 'search', 'clear-selection', 'auto-reconcile', 'select-row']);
